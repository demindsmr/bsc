...
```shell
go get github.com/demindsmr/bsc/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/demindsmr/bsc/blob/master/params/config.go#L251).*
